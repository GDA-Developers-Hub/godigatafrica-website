...
import facebook from "../../../assets/facebook-ads.jpeg";
import team from "../../../assets/home-image.jpg";
...
export default function SocialMediaMarketing() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-950 to-slate-900">
      <ServiceSEO service="socialMediaMarketing" />
      <HeroSection />
      <ServicesSection />
      <MetaPartnerSection />
      <EngagementSection />
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-white max-w-3xl mx-auto font-bold">
              Strategic solutions to enhance your brand's social media presence
            </p>
          </motion.div>
            ...
            {[
              ...
              },
              {
                ...
                features: [
                  ...
                  "Content creation (24 posts)",
                  "Premium graphics & video",
                  "Influencer partnership mgmt",
              ...
              >
                {pkg.popular && (
                  <div className="absolute -top-4 left-1/2 -translate-x-1/2">
                    <div className="bg-gradient-to-r from-blue-500 to-cyan-500 text-white text-sm font-medium px-4 py-1 rounded-full">
                      Most Popular
                    </div>
                  </div>
                )}
          ...
          <motion.div 
            ...
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
            className="bg-gray-800 p-8 rounded-2xl border-2 border-cyan-500/20 max-w-4xl mx-auto"
          >
            <div className="text-center">
              <h3 className="text-2xl font-bold text-white mb-4">Custom Enterprise Solution</h3>
              <p className="text-slate-300 mb-6">
                Need a comprehensive social media marketing strategy for your brand? Our custom packages start at <span className="text-white font-bold">Ksh 55,000+</span> and include dedicated account teams, premium content production, and advanced analytics tailored to your specific industry.
              </p>
              <Link
                to="/proposal-request"
                className="inline-block bg-gradient-to-r from-blue-500 to-cyan-600 text-white px-8 py-3 rounded-full font-medium hover:shadow-lg transition-all duration-300"
              >
...
function HeroSection() {
  return (
    <section className="relative py-30 overflow-hidden bg-[var(--background)]">
      ...
      <div className="container mx-auto px-4 relative">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          >
            ...
            <button className="bg-white  text-black border-0 group px-4 py-5 rounded-full flex items-center justify-center">
              GET A QUOTE
          ...
          >
            <div className="relative rounded-2xl overflow-hidden border border-blue-400 ">
              <img
                src={socialmedia}
                ...
                <div className="grid grid-cols-3 gap-4">
                  {[Bell, Share2, MessageCircle].map((Icon, index) => (
                    <motion.div
                      ...
                      className="w-12 h-12 bg-blue-400 backdrop-blur-sm rounded-full flex items-center justify-center"
                    >
                      <Icon className="h-6 w-6 tet-black" />
                    </motion.div>
                  ))}
                </div>
              </div>
    ...
    <section className="relative py-24 overflow-hidden bg-[var(--background-light)]">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          ...
          <div className="h-1 w-24 bg-gradient-to-r from-blue-400 via-blue-500  mx-auto mb-8 rounded-full" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <motion.div
              ...
              transition={{ duration: 0.5, delay: index * 0.1 }}
              viewport={{ once: true }}
              className="group relative p-8 rounded-xl bg-slate-800 backdrop-blur-sm border border-white/10 hover:border-cyan-500/30 transition-all duration-300"
            >
              <div
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            <div className="p-8 rounded-xl bg-white/5 backdrop-blur-sm border border-cyan-500/30">
              <img src={meta} alt="Meta Business Partner" className="w-full h-auto" />
            </div>
          </motion.div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 relative">
        <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
          ...
          >
            ...
            <button className="mt-8 bg-blue-400  text-white border-0 group px-4 py-2 rounded-full">
...
function TeamSection() {
  return (
    <section className="relative py-24 overflow-hidden bg-[var(--light-bg)]/80">
            ...
            <div className="mt-8 grid grid-cols-3 gap-4">
              {["Strategy", "Content", "Design"].map((skill, index) => (
                <motion.div
                  ...
                  transition={{ duration: 0.5, delay: index * 0.1 }}
                  viewport={{ once: true }}
                  className="p-4 rounded-lg bg-slate-800 backdrop-blur-sm border border-cyan-500/20 text-center"
                >
