...
export default function CofounderForm({ onSubmit, onCancel, employee = null }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error("Error formatting co-founder data:", err)
      setError("Failed to process co-founder data")
    } finally {
