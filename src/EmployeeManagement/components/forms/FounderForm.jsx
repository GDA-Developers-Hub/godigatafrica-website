...
export default function FounderForm({ onSubmit, onCancel, employee = null }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error("Error formatting founder data:", err)
      setError("Failed to process founder data")
    } finally {
 ...
 <form onSubmit={handleSubmit} className="flex flex-col h-full max-h-[80vh]">
      ...
      <div className="flex-grow overflow-y-auto pr-2">
        ...
        <div className="flex justify-end gap-2 py-4 border-t border-slate-700 mt-4 bg-slate-800 sticky bottom-0">
          <button
            type="button"
            onClick={onCancel}
